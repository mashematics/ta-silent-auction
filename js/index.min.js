function anonymousLogin(){auth.signInAnonymously();var e=auth.currentUser;if(e.displayName)alert("Welcome back "+e.displayName);else{var a=prompt("Please enter your name","Rita Tingewick");e.updateProfile({displayName:a}),db.collection("users").doc(a).set({uid:e.uid})}}
