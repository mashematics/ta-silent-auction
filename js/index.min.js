var endTime=new Date(2015,12,5).getTime()/1e3;function setClock(){var e=(new Date).getTime()/1e3,t=endTime-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("timeRemaining").innerHTML=n,setTimeout(setClock,1e3)}setClock();var endTime2=new Date(2015,12,4).getTime()/1e3;function setClock2(){var e=(new Date).getTime()/1e3,t=endTime2-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("2-timeRemaining").innerHTML=n,setTimeout(setClock2,1e3)}setClock2();var endTime3=new Date(2015,12,3).getTime()/1e3;function setClock3(){var e=(new Date).getTime()/1e3,t=endTime3-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("3-timeRemaining").innerHTML=n,setTimeout(setClock3,1e3)}setClock3();var endTime4=new Date(2015,12,2).getTime()/1e3;function setClock4(){var e=(new Date).getTime()/1e3,t=endTime4-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("4-timeRemaining").innerHTML=n,setTimeout(setClock4,1e3)}setClock4();var endTime5=new Date(2015,12,6).getTime()/1e3;function setClock5(){var e=(new Date).getTime()/1e3,t=endTime5-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("5-timeRemaining").innerHTML=n,setTimeout(setClock5,1e3)}setClock5();var endTime6=new Date(2015,12,3).getTime()/1e3;function setClock6(){var e=(new Date).getTime()/1e3,t=endTime6-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("6-timeRemaining").innerHTML=n,setTimeout(setClock6,1e3)}setClock6();var endTime7=new Date(2015,12,10).getTime()/1e3;function setClock7(){var e=(new Date).getTime()/1e3,t=endTime7-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("7-timeRemaining").innerHTML=n,setTimeout(setClock7,1e3)}setClock7();var endTime8=new Date(2015,12,1).getTime()/1e3;function setClock8(){var e=(new Date).getTime()/1e3,t=endTime8-e,n=parseInt(t/86400)+" d "+parseInt(t/3600)%24+" h "+parseInt(t/60)%60+" m "+parseInt(t%60,10)+" s ";document.getElementById("8-timeRemaining").innerHTML=n,setTimeout(setClock8,1e3)}setClock8();
